...
public class SchemalessQueryLoadTestRunner {
    ...
    private Map<String, String> createSchemalessConnectorConfiguration() {
        ...
        connectorConfig.put("fetch.max.bytes", "100000000");
        connectorConfig.put("consumer.override.fetch.max.bytes", "100000000");
        ...
        connectorConfig.put("max.partition.fetch.bytes", "100000000");
        connectorConfig.put("producer.override.max.request.size", "10485760");
        connectorConfig.put("consumer.override.max.partition.fetch.bytes", "100000000");
        ...
        connectorConfig.put("maxQuerySize", "20000000");
