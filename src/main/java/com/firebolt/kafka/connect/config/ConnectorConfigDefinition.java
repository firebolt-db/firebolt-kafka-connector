...
public class ConnectorConfigDefinition {
    ...
    public static final String INGESTION_TYPE_DOC = "Deprecated and ignored. All ingestion uploads Parquet and ingests via read_parquet(). Accepted for backwards compatibility with existing connector configs.";
