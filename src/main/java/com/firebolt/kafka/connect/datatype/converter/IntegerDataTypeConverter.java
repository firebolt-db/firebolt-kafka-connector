...
public class IntegerDataTypeConverter extends NumericDataTypeConverter {
    ...
    public void convertAndSet(PreparedStatement statement, int paramIndex, KafkaMessageColumnValue kafkaMessageColumnValue, TableSchema.Column fireboltColumn) throws SQLException {
        ...
        throw new ColumnConversionFailedException(fireboltColumn.getName(), fireboltColumn.getDataType(), "Cannot convert kafka message attribute to a integer due to incompatible type: " + (value != null ? value.getClass().getName() : "null"));
    }
